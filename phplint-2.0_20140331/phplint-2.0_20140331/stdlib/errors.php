...
/**
	...
	Moreover, always enabled the <tt>track_errors</tt> option that creates the
	special variable <tt>$php_errormsg</tt> containing the description of the
	error; this overrides any setting of the php.ini file.
	...
	@version $Date: 2014/02/23 18:11:12 $
*/
