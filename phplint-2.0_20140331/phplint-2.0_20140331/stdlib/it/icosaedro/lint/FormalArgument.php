...
class FormalArgument implements Comparable, Printable {
	...
	/**
	 * NULL if the argument is mandatory, otherwise it is the
	 * literal representation of the default value. This property can be NULL
	 * if the expression cannot be parsed.
	 * FIXME: format of this string? (take Result as example)
	 * @var string
	 */
	public $value;
	...
	public function __toString(){
		...
		if( ! $this->is_mandatory ){
			...
			if( $this->value === NULL )
				...
				$s .= Strings::toLiteral($this->value);
			else
				$s .= $this->value;
		}
		return $s;
