 ...
 * @version $Date: 2014/03/19 15:58:37 $
 */
class Documentator {
	...
	/**
	 * Reference remapping (UNIMPLEMENTED YET).
	 */
...
"\n"
	...
	private function writeValue($type, $value){
		if( $type instanceof StringType )
			$this->write(Strings::toLiteral($value));
		else
			$this->write($value);
	}
...
//		}
	...
	public function generate($fn) {
		$this->relative_path = new RelativePathBuilder($fn, $this->extension);
