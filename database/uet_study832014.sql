...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2014 at 04:07 PM
...
INSERT INTO `tbl_user` (`user_id`, `user_name`, `user_password`, `user_status`, `user_email`, `user_class`, `user_faculty`, `user_about`, `user_type`, `user_avatar`) VALUES
(2, '', NULL, NULL, '', NULL, NULL, NULL, NULL, NULL),
(4, 'vungocson', '123456', NULL, 'vungocson94@gmail.com', NULL, NULL, NULL, NULL, NULL),
(5, 'khoalevan', '123456', NULL, 'khoalevan1994@gmail.com', NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `tbl_doc`
  ADD CONSTRAINT `tbl_doc_ibfk_4` FOREIGN KEY (`doc_faculty_id`) REFERENCES `tbl_faculty` (`faculty_id`),
  ADD CONSTRAINT `tbl_doc_ibfk_1` FOREIGN KEY (`doc_user_id`) REFERENCES `tbl_user` (`user_id`),
  ADD CONSTRAINT `tbl_doc_ibfk_2` FOREIGN KEY (`doc_id`) REFERENCES `tbl_comment` (`comment_post_id`),
