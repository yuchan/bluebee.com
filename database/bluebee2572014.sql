...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 25, 2014 at 01:11 PM
...
CREATE TABLE IF NOT EXISTS `tbl_doc` (
  ...
  `doc_publisher` varchar(200) DEFAULT NULL,
  `doc_status` varchar(200) DEFAULT NULL,
  `doc_author` varchar(50) DEFAULT NULL,
...
INSERT INTO `tbl_doc` (`doc_id`, `doc_url`, `doc_name`, `doc_scribd_id`, `doc_description`, `doc_publisher`, `doc_status`, `doc_author`, `doc_type`) VALUES
(1, NULL, 'Đại số tuyến tính và hình học giải tích', NULL, NULL, NULL, NULL, 'Trần Trọng Huệ', NULL);
...
CREATE TABLE IF NOT EXISTS `tbl_subject` (
  ...
  `subject_content` varchar(1000) NOT NULL,
...
INSERT INTO `tbl_subject` (`subject_id`, `subject_name`, `subject_code`, `subject_active`, `subject_university`, `subject_type`, `subject_year`, `subject_credits`, `subject_credit_hour`, `subject_requirement`, `subject_content`, `subject_target`, `subject_info`, `subject_test`, `subject_faculty`, `subject_dept`) VALUES
(1, 'Đại số tuyến tính', 'INT1006', '1', NULL, 1, NULL, 3, '20 - 23 - 2', NULL, 'Đại số tuyến tính là một trong những môn học đầu tiên của Toán học trừu tượng, sinh viên cần nắm vững các khái niệm, hình dung chính xác các khái niệm đó trong những tình huống cụ thể, biết vận dụng các kết quả mới. Phần đầu chương trình ôn tập lại các khái niệm về tập hợp và ánh xạ, sau đó giới thiệu một số cấu trúc đại số như nhóm, vành, trường. Một thời lượng đáng kể dành cho việc giới thiệu trường số phức, các tính chất của số phức, đa thức và phân thức hữu tỉ thực. Chương III là lý thuyết về ma trận, định thức và hệ phương trình tuyến tính. Ở chương này sinh viên sẽ được ôn lại cách giải hệ phương trình tuyến tính đã học từ chương trình phổ thông. Tuy vậy toàn bộ lý thuyết sẽ được trình bày một cách có hệ thống và ở một ngôn ngữ tổng quát. Chương IV gồm những vấn đề cơ bản của không gian véc tơ, không gian Euclid. Đây có thể coi như những tổng quát hóa lên trường hợp nhiều chiều của các khái niệm mặt phẳng toạ độ, hệ toạ độ trong không gian mà sinh viên đã nắm vững từ bậc phổ thôn', 'Trang bị cho sinh viên những khái niệm và kỹ năng cơ bản nhất của Đại số tuyến tính một trong những môn cơ sở của Toán học, tạo điều kiện để học tập, nghiên cứu các môn học khác.\r\n                                Giúp sinh viên hiểu được các kiến thức cơ bản của Đại số tuyến tính, liên hệ với những kiến thức đã học ở bậc phổ thông, biết cách tự hệ thống hoá kiến thức, tìm tòi mở rộng thêm các kiến thức cơ bản để phục vụ công tác sau này.', NULL, NULL, 1, 1),
