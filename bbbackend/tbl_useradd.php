...
class ctbl_user_add extends ctbl_user {
	...
	function LoadDefaultValues() {
		$this->user_id_fb->CurrentValue = NULL;
		$this->user_id_fb->OldValue = $this->user_id_fb->CurrentValue;
		$this->username->CurrentValue = NULL;
		$this->username->OldValue = $this->username->CurrentValue;
		$this->password->CurrentValue = NULL;
		$this->password->OldValue = $this->password->CurrentValue;
		$this->user_real_name->CurrentValue = NULL;
		$this->user_real_name->OldValue = $this->user_real_name->CurrentValue;
		$this->user_avatar->CurrentValue = NULL;
		$this->user_avatar->OldValue = $this->user_avatar->CurrentValue;
		$this->user_cover->CurrentValue = NULL;
		$this->user_cover->OldValue = $this->user_cover->CurrentValue;
		$this->user_student_code->CurrentValue = NULL;
		$this->user_student_code->OldValue = $this->user_student_code->CurrentValue;
		$this->user_university->CurrentValue = NULL;
		$this->user_university->OldValue = $this->user_university->CurrentValue;
		$this->user_gender->CurrentValue = NULL;
		$this->user_gender->OldValue = $this->user_gender->CurrentValue;
		$this->user_dob->CurrentValue = NULL;
		$this->user_dob->OldValue = $this->user_dob->CurrentValue;
		$this->user_hometown->CurrentValue = NULL;
		$this->user_hometown->OldValue = $this->user_hometown->CurrentValue;
		$this->user_phone->CurrentValue = NULL;
		$this->user_phone->OldValue = $this->user_phone->CurrentValue;
		$this->user_description->CurrentValue = NULL;
		$this->user_description->OldValue = $this->user_description->CurrentValue;
		$this->user_faculty->CurrentValue = NULL;
		$this->user_faculty->OldValue = $this->user_faculty->CurrentValue;
		$this->user_class->CurrentValue = NULL;
		$this->user_class->OldValue = $this->user_class->CurrentValue;
		$this->user_active->CurrentValue = NULL;
		$this->user_active->OldValue = $this->user_active->CurrentValue;
		...
		$this->user_activator->CurrentValue = NULL;
		$this->user_activator->OldValue = $this->user_activator->CurrentValue;
		$this->user_qoutes->CurrentValue = NULL;
		$this->user_qoutes->OldValue = $this->user_qoutes->CurrentValue;
		$this->user_date_attend->CurrentValue = NULL;
		$this->user_date_attend->OldValue = $this->user_date_attend->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// user_id_fb
		$this->user_id_fb->SetDbValueDef($rsnew, $this->user_id_fb->CurrentValue, NULL, FALSE);
		...
		// user_real_name
		$this->user_real_name->SetDbValueDef($rsnew, $this->user_real_name->CurrentValue, NULL, FALSE);

		// user_avatar
		$this->user_avatar->SetDbValueDef($rsnew, $this->user_avatar->CurrentValue, NULL, FALSE);

		// user_cover
		$this->user_cover->SetDbValueDef($rsnew, $this->user_cover->CurrentValue, NULL, FALSE);

		// user_student_code
		$this->user_student_code->SetDbValueDef($rsnew, $this->user_student_code->CurrentValue, NULL, FALSE);

		// user_university
		$this->user_university->SetDbValueDef($rsnew, $this->user_university->CurrentValue, NULL, FALSE);

		// user_gender
		$this->user_gender->SetDbValueDef($rsnew, $this->user_gender->CurrentValue, NULL, FALSE);

		// user_dob
		$this->user_dob->SetDbValueDef($rsnew, $this->user_dob->CurrentValue, NULL, FALSE);

		// user_hometown
		$this->user_hometown->SetDbValueDef($rsnew, $this->user_hometown->CurrentValue, NULL, FALSE);

		// user_phone
		$this->user_phone->SetDbValueDef($rsnew, $this->user_phone->CurrentValue, NULL, FALSE);

		// user_description
		$this->user_description->SetDbValueDef($rsnew, $this->user_description->CurrentValue, NULL, FALSE);

		// user_faculty
		$this->user_faculty->SetDbValueDef($rsnew, $this->user_faculty->CurrentValue, NULL, FALSE);

		// user_class
		$this->user_class->SetDbValueDef($rsnew, $this->user_class->CurrentValue, NULL, FALSE);

		// user_active
		$this->user_active->SetDbValueDef($rsnew, $this->user_active->CurrentValue, NULL, FALSE);

		// user_status
		$this->user_status->SetDbValueDef($rsnew, $this->user_status->CurrentValue, NULL, FALSE);

		// user_group
		$this->user_group->SetDbValueDef($rsnew, $this->user_group->CurrentValue, NULL, FALSE);

		// user_token
		$this->user_token->SetDbValueDef($rsnew, $this->user_token->CurrentValue, NULL, FALSE);

		// user_activator
		$this->user_activator->SetDbValueDef($rsnew, $this->user_activator->CurrentValue, NULL, FALSE);

		// user_qoutes
		$this->user_qoutes->SetDbValueDef($rsnew, $this->user_qoutes->CurrentValue, NULL, FALSE);

		// user_date_attend
		$this->user_date_attend->SetDbValueDef($rsnew, $this->user_date_attend->CurrentValue, NULL, FALSE);
...
// Validate form
ftbl_useradd.Validate = function(fobj) {
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $tbl_user->TableCaption() ?></span></p>
...
?>
<form name="ftbl_useradd" id="ftbl_useradd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="tbl_user">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_tbl_useradd" class="ewTable">
...
<script type="text/javascript">
ew_CreateEditor("ftbl_useradd", "x_user_date_attend", 0, 0, <?php echo ($tbl_user->user_date_attend->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
