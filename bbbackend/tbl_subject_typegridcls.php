...
$tbl_subject_type_grid = NULL; // Initialize page object first

class ctbl_subject_type_grid extends ctbl_subject_type {
	...
	// Page object name
	var $PageObjName = 'tbl_subject_type_grid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["tbl_subject_type"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_subject_type_name") && $objForm->HasValue("o_subject_type_name") && $this->subject_type_name->CurrentValue <> $this->subject_type_name->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_is_active") && $objForm->HasValue("o_is_active") && $this->is_active->CurrentValue <> $this->is_active->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->subject_type_name->setOldValue($objForm->GetValue("o_subject_type_name"));
		if (!$this->is_active->FldIsDetailKey) {
			$this->is_active->setFormValue($objForm->GetValue("x_is_active"));
		}
		$this->is_active->setOldValue($objForm->GetValue("o_is_active"));
	}
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "tbl_subject") {
			...
			if ($GLOBALS["tbl_subject"]->EventCancelled) $this->EventCancelled = TRUE;
		}
