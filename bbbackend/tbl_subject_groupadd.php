...
$tbl_subject_group_add = NULL; // Initialize page object first

class ctbl_subject_group_add extends ctbl_subject_group {
	...
	// Page object name
	var $PageObjName = 'tbl_subject_group_add';
	...
	function LoadDefaultValues() {
		$this->subject_type_id->CurrentValue = NULL;
		$this->subject_type_id->OldValue = $this->subject_type_id->CurrentValue;
		...
		$this->subject_group_name->CurrentValue = NULL;
		$this->subject_group_name->OldValue = $this->subject_group_name->CurrentValue;
		$this->subject_group_info->CurrentValue = NULL;
		$this->subject_group_info->OldValue = $this->subject_group_info->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// subject_type_id
		$this->subject_type_id->SetDbValueDef($rsnew, $this->subject_type_id->CurrentValue, NULL, FALSE);

		// faculty_id
		$this->faculty_id->SetDbValueDef($rsnew, $this->faculty_id->CurrentValue, NULL, FALSE);

		// dept_id
		$this->dept_id->SetDbValueDef($rsnew, $this->dept_id->CurrentValue, NULL, FALSE);

		// subject_group_name
		$this->subject_group_name->SetDbValueDef($rsnew, $this->subject_group_name->CurrentValue, NULL, FALSE);

		// subject_group_info
		$this->subject_group_info->SetDbValueDef($rsnew, $this->subject_group_info->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($tbl_subject_group_add)) $tbl_subject_group_add = new ctbl_subject_group_add();

// Page init
$tbl_subject_group_add->Page_Init();

// Page main
$tbl_subject_group_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var tbl_subject_group_add = new ew_Page("tbl_subject_group_add");
tbl_subject_group_add.PageID = "add"; // Page ID
var EW_PAGE_ID = tbl_subject_group_add.PageID; // For backward compatibility

// Form object
var ftbl_subject_groupadd = new ew_Form("ftbl_subject_groupadd");

// Validate form
ftbl_subject_groupadd.Validate = function(fobj) {
...
ftbl_subject_groupadd.Form_CustomValidate =  
...
ftbl_subject_groupadd.ValidateRequired = true;
<?php } else { ?>
ftbl_subject_groupadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftbl_subject_groupadd.Lists["x_subject_type_id"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_subject_type_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ftbl_subject_groupadd.Lists["x_faculty_id"] = {"LinkField":"x_faculty_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_faculty_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ftbl_subject_groupadd.Lists["x_dept_id"] = {"LinkField":"x_dept_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_dept_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $tbl_subject_group->TableCaption() ?></span></p>
...
<?php $tbl_subject_group_add->ShowPageHeader(); ?>
<?php
$tbl_subject_group_add->ShowMessage();
?>
<form name="ftbl_subject_groupadd" id="ftbl_subject_groupadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="tbl_subject_group">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_tbl_subject_groupadd" class="ewTable">
...
<script type="text/javascript">
ftbl_subject_groupadd.Lists["x_subject_type_id"].Options = <?php echo (is_array($tbl_subject_group->subject_type_id->EditValue)) ? ew_ArrayToJson($tbl_subject_group->subject_type_id->EditValue, 1) : "[]" ?>;
</script>
...
<script type="text/javascript">
ftbl_subject_groupadd.Lists["x_faculty_id"].Options = <?php echo (is_array($tbl_subject_group->faculty_id->EditValue)) ? ew_ArrayToJson($tbl_subject_group->faculty_id->EditValue, 1) : "[]" ?>;
</script>
...
<script type="text/javascript">
ftbl_subject_groupadd.Lists["x_dept_id"].Options = <?php echo (is_array($tbl_subject_group->dept_id->EditValue)) ? ew_ArrayToJson($tbl_subject_group->dept_id->EditValue, 1) : "[]" ?>;
</script>
...
<script type="text/javascript">
ew_CreateEditor("ftbl_subject_groupadd", "x_subject_group_name", 0, 0, <?php echo ($tbl_subject_group->subject_group_name->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<script type="text/javascript">
ew_CreateEditor("ftbl_subject_groupadd", "x_subject_group_info", 35, 4, <?php echo ($tbl_subject_group->subject_group_info->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<script type="text/javascript">
ftbl_subject_groupadd.Init();
</script>
<?php
$tbl_subject_group_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_subject_group_add->Page_Terminate();
?>
