...
$tbl_subject_teacher = NULL;

//
// Table class for tbl_subject_teacher
//
class ctbl_subject_teacher extends cTable {
	var $id;
	var $subject_id;
	var $teacher_id;
	var $is_active;
	...
	function __construct() {
		...
		$this->TableVar = 'tbl_subject_teacher';
		$this->TableName = 'tbl_subject_teacher';
		...
		// id
		$this->id = new cField('tbl_subject_teacher', 'tbl_subject_teacher', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// subject_id
		$this->subject_id = new cField('tbl_subject_teacher', 'tbl_subject_teacher', 'x_subject_id', 'subject_id', '`subject_id`', '`subject_id`', 3, -1, FALSE, '`subject_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->subject_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['subject_id'] = &$this->subject_id;

		// teacher_id
		$this->teacher_id = new cField('tbl_subject_teacher', 'tbl_subject_teacher', 'x_teacher_id', 'teacher_id', '`teacher_id`', '`teacher_id`', 3, -1, FALSE, '`teacher_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->teacher_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['teacher_id'] = &$this->teacher_id;

		// is_active
		$this->is_active = new cField('tbl_subject_teacher', 'tbl_subject_teacher', 'x_is_active', 'is_active', '`is_active`', '`is_active`', 3, -1, FALSE, '`is_active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`tbl_subject_teacher`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tbl_subject_teacherlist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("tbl_subject_teacherview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "tbl_subject_teacheradd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tbl_subject_teacheredit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tbl_subject_teacheradd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbl_subject_teacherdelete.php", $this->UrlParm());
	}
