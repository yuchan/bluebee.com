...
$tbl_subject_teacher_add = NULL; // Initialize page object first

class ctbl_subject_teacher_add extends ctbl_subject_teacher {
	...
	// Page object name
	var $PageObjName = 'tbl_subject_teacher_add';
...
// Create page object
if (!isset($tbl_subject_teacher_add)) $tbl_subject_teacher_add = new ctbl_subject_teacher_add();

// Page init
$tbl_subject_teacher_add->Page_Init();

// Page main
$tbl_subject_teacher_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var tbl_subject_teacher_add = new ew_Page("tbl_subject_teacher_add");
tbl_subject_teacher_add.PageID = "add"; // Page ID
var EW_PAGE_ID = tbl_subject_teacher_add.PageID; // For backward compatibility

// Form object
var ftbl_subject_teacheradd = new ew_Form("ftbl_subject_teacheradd");

// Validate form
ftbl_subject_teacheradd.Validate = function(fobj) {
...
ftbl_subject_teacheradd.Form_CustomValidate =  
...
ftbl_subject_teacheradd.ValidateRequired = true;
<?php } else { ?>
ftbl_subject_teacheradd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftbl_subject_teacheradd.Lists["x_subject_id"] = {"LinkField":"x_subject_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_subject_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ftbl_subject_teacheradd.Lists["x_teacher_id"] = {"LinkField":"x_teacher_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_teacher_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $tbl_subject_teacher->TableCaption() ?></span></p>
...
<?php $tbl_subject_teacher_add->ShowPageHeader(); ?>
<?php
$tbl_subject_teacher_add->ShowMessage();
?>
<form name="ftbl_subject_teacheradd" id="ftbl_subject_teacheradd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="tbl_subject_teacher">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_tbl_subject_teacheradd" class="ewTable">
...
<script type="text/javascript">
ftbl_subject_teacheradd.Lists["x_subject_id"].Options = <?php echo (is_array($tbl_subject_teacher->subject_id->EditValue)) ? ew_ArrayToJson($tbl_subject_teacher->subject_id->EditValue, 1) : "[]" ?>;
</script>
...
<script type="text/javascript">
ftbl_subject_teacheradd.Lists["x_teacher_id"].Options = <?php echo (is_array($tbl_subject_teacher->teacher_id->EditValue)) ? ew_ArrayToJson($tbl_subject_teacher->teacher_id->EditValue, 1) : "[]" ?>;
</script>
...
<script type="text/javascript">
ftbl_subject_teacheradd.Init();
</script>
<?php
$tbl_subject_teacher_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_subject_teacher_add->Page_Terminate();
?>
