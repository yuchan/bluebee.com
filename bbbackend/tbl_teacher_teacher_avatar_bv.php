...
$tbl_teacher_teacher_avatar_blobview = NULL; // Initialize page object first

class ctbl_teacher_teacher_avatar_blobview extends ctbl_teacher {
	...
	// Page object name
	var $PageObjName = 'tbl_teacher_teacher_avatar_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('tbl_teacher', 'x_teacher_avatar');
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (!EW_DEBUG_ENABLED && ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('teacher_avatar');
				...
				if (trim(strval($this->Recordset->fields('teacher_avatar'))) <> "") {
					header("Content-Disposition: attachment; filename=\"" . $this->Recordset->fields('teacher_avatar') . "\"");
				}
...
// Create page object
if (!isset($tbl_teacher_teacher_avatar_blobview)) $tbl_teacher_teacher_avatar_blobview = new ctbl_teacher_teacher_avatar_blobview();

// Page init
$tbl_teacher_teacher_avatar_blobview->Page_Init();

// Page main
$tbl_teacher_teacher_avatar_blobview->Page_Main();
?>
<?php
$tbl_teacher_teacher_avatar_blobview->Page_Terminate();
?>
