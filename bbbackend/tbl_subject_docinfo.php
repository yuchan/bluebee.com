...
$tbl_subject_doc = NULL;

//
// Table class for tbl_subject_doc
//
class ctbl_subject_doc extends cTable {
	var $id;
	var $subject_id;
	var $doc_id;
	var $doc_type;
	...
	function __construct() {
		...
		$this->TableVar = 'tbl_subject_doc';
		$this->TableName = 'tbl_subject_doc';
		...
		// id
		$this->id = new cField('tbl_subject_doc', 'tbl_subject_doc', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// subject_id
		$this->subject_id = new cField('tbl_subject_doc', 'tbl_subject_doc', 'x_subject_id', 'subject_id', '`subject_id`', '`subject_id`', 3, -1, FALSE, '`subject_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->subject_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['subject_id'] = &$this->subject_id;

		// doc_id
		$this->doc_id = new cField('tbl_subject_doc', 'tbl_subject_doc', 'x_doc_id', 'doc_id', '`doc_id`', '`doc_id`', 3, -1, FALSE, '`doc_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->doc_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['doc_id'] = &$this->doc_id;

		// doc_type
		$this->doc_type = new cField('tbl_subject_doc', 'tbl_subject_doc', 'x_doc_type', 'doc_type', '`doc_type`', '`doc_type`', 3, -1, FALSE, '`doc_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->doc_type->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['doc_type'] = &$this->doc_type;

		// active
		$this->active = new cField('tbl_subject_doc', 'tbl_subject_doc', 'x_active', 'active', '`active`', '`active`', 3, -1, FALSE, '`active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`tbl_subject_doc`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tbl_subject_doclist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("tbl_subject_docview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "tbl_subject_docadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tbl_subject_docedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tbl_subject_docadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbl_subject_docdelete.php", $this->UrlParm());
	}
