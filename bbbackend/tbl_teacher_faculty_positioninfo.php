...
$tbl_teacher_faculty_position = NULL;

//
// Table class for tbl_teacher_faculty_position
//
class ctbl_teacher_faculty_position extends cTable {
	var $id;
	var $teacher_id;
	var $teacher_name;
	var $faculty_id;
	...
	function __construct() {
		...
		$this->TableVar = 'tbl_teacher_faculty_position';
		$this->TableName = 'tbl_teacher_faculty_position';
		...
		// id
		$this->id = new cField('tbl_teacher_faculty_position', 'tbl_teacher_faculty_position', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// teacher_id
		$this->teacher_id = new cField('tbl_teacher_faculty_position', 'tbl_teacher_faculty_position', 'x_teacher_id', 'teacher_id', '`teacher_id`', '`teacher_id`', 3, -1, FALSE, '`teacher_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->teacher_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['teacher_id'] = &$this->teacher_id;

		// teacher_name
		$this->teacher_name = new cField('tbl_teacher_faculty_position', 'tbl_teacher_faculty_position', 'x_teacher_name', 'teacher_name', '`teacher_name`', '`teacher_name`', 200, -1, FALSE, '`teacher_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['teacher_name'] = &$this->teacher_name;

		// faculty_id
		$this->faculty_id = new cField('tbl_teacher_faculty_position', 'tbl_teacher_faculty_position', 'x_faculty_id', 'faculty_id', '`faculty_id`', '`faculty_id`', 3, -1, FALSE, '`faculty_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->faculty_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['faculty_id'] = &$this->faculty_id;

		// teacher_position
		$this->teacher_position = new cField('tbl_teacher_faculty_position', 'tbl_teacher_faculty_position', 'x_teacher_position', 'teacher_position', '`teacher_position`', '`teacher_position`', 200, -1, FALSE, '`teacher_position`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['teacher_position'] = &$this->teacher_position;
	}
	...
	// Update Table
	var $UpdateTable = "`tbl_teacher_faculty_position`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tbl_teacher_faculty_positionlist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("tbl_teacher_faculty_positionview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "tbl_teacher_faculty_positionadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tbl_teacher_faculty_positionedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tbl_teacher_faculty_positionadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbl_teacher_faculty_positiondelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->teacher_position->Exportable) $Doc->ExportCaption($this->teacher_position);
			} else {
				if ($this->id->Exportable) $Doc->ExportCaption($this->id);
				if ($this->teacher_id->Exportable) $Doc->ExportCaption($this->teacher_id);
				if ($this->teacher_name->Exportable) $Doc->ExportCaption($this->teacher_name);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->teacher_position->Exportable) $Doc->ExportField($this->teacher_position);
				} else {
					if ($this->id->Exportable) $Doc->ExportField($this->id);
					if ($this->teacher_id->Exportable) $Doc->ExportField($this->teacher_id);
					if ($this->teacher_name->Exportable) $Doc->ExportField($this->teacher_name);
