<div class="l-submain-h i-cf" style="margin-top: 30px">
    <div class="g-cols">
                ...
                <div class="morph-content">
                    <div class="content-style-text">
                        ...
                        <label class="g-btn size_small type_primary upload_button">
                            <input class="ssa" type="file" multiple="multiple" name="uploadedfile[]" style="display: none;" />
                        ...
                        <input id="name_document" type="text" placeholder="Tên tài liệu"/>
                        <textarea id="description_document" placeholder="Mô tả"></textarea>
                        <select style="max-width: 200px; border-radius: 3px; background-color: white; margin: 5px 0;">
