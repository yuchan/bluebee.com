            ...
            <div class="three-fourths">
                ...
                <div class="g-cols">
                    <div class="two-thirds" >
                        ...
                        <p style="margin-right: 20px">
                            <strong>1. Về kiến thức</strong> <br/>
                            Sinh viên tốt nghiệp được trang bị kiến thức có hệ thống và hiện đại, phù hợp với các chương trình đào tạo tiên tiến trên thế giới.  <br/>
                ...
                <div class="g-cols">
                    <div class="full-width">
                        <strong>2. Về năng lực:  Sinh viên ra trường có</strong> <br/>
                        ...
                        <br/>
                        <strong>3. Về thái độ: Cử nhân ngành KHMT có</strong> <br/>
                        ...
                        <p>
                            <a href="#">Chuẩn đầu ra của chương trình đào tạo</a> giúp sinh viên có thể đảm nhận :<br/>
