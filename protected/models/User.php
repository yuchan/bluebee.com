...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('username, password, user_real_name, user_cover, user_student_code, user_gender, user_dob, user_hometown, user_phone, user_description', 'length', 'max'=>45),
			array('user_avatar, user_token, user_activator', 'length', 'max'=>200),
